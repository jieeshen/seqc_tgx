...
-i labelfile -j datafile -d outputDIR"""
    ...
    labelMatrix=readfile_int(labelfile)   #get label matrix without title line (original file has the title)
...
def getSVMinput(labelmatrix):
    ...
    for line in labelmatrix:
        newtitles.append(line[0])     #sampletitle
        Y.append(line[1])
